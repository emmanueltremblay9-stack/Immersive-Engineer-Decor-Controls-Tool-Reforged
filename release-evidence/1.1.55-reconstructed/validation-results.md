...
| Sign visual screenshot | NOT_PERFORMED | GUI-control surface could not automate the Minecraft client; no visual-runtime claim is made. |
| CI final head | PENDING | Requires the release PR head to exist remotely. |
| Prism installation | NOT_PERFORMED | Deferred until the reviewed final candidate is selected. |
